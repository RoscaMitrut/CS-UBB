...
public class NetworkService implements Service {
    private final RepoPaginat<String, User> userRepository;
     ...
     */
    public NetworkService(RepoPaginat<String, User> userRepository, Validator<User> userValidator,
    ...
    public Iterable<User> getAllUsersPaginat(Integer limit,Integer offset){
        return userRepository.findAllPaginat(limit,offset);
    }
    ...
    public boolean verifyCredentials(User user, String password) {
        return Objects.equals(user.getDecryptedPassword(), password);
    }
    ...
    public Message saveMessage(String text, String sender, String receiver){
        ...
        return this.messagesDbRepository.save(new Message(id, text, date, sender, receiver));
    }
