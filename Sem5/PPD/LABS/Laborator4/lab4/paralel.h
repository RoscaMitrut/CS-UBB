...
void reader(int start, int end, vector<string>& in_f, MyLinkedList& list, int threads_count) {
...
void writer(int readers_count, MyLinkedList& list, MyLinkedList& black_list) {
    bool cond = true;
    while (cond) {
        pair<int, int> result;
